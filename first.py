...
inner_frame.pack()
status_label = Label(inner_frame, text="<< grow >>", width=10)
status_label.pack(side=LEFT, pady=5, padx=10)
time_label = Label(inner_frame, text="", width=10)
time_label.pack(side=LEFT, pady=5, padx=10)
...
l1.pack(side=LEFT)
lb_red = Label(counts_frame, text="red", width=10)
lb_red.pack(side=LEFT, pady=5, padx=10)
l2 = Label(counts_frame, bg="gray", text="Green:", width=5)
l2.pack(side=LEFT)
lb_green = Label(counts_frame, text="green", width=10)
lb_green.pack(side=LEFT, pady=5, padx=10)
l3 = Label(counts_frame, bg="gray", text="Blue:", width=5)
l3.pack(side=LEFT)
lb_blue = Label(counts_frame, text="blue", width=10)
lb_blue.pack(side=LEFT, pady=5, padx=10)

points_frame = Frame(root, bg="gray")
points_frame.pack()
l1 = Label(points_frame, bg="gray", text="points", width=5)
l1.pack(side=LEFT)
lb_red_points = Label(points_frame, text="red", width=10)
lb_red_points.pack(side=LEFT, pady=5, padx=10)
l2 = Label(points_frame, bg="gray", text="points", width=5)
l2.pack(side=LEFT)
lb_green_points = Label(points_frame, text="green", width=10)
lb_green_points.pack(side=LEFT, pady=5, padx=10)
l3 = Label(points_frame, bg="gray", text="points", width=5)
l3.pack(side=LEFT)
lb_blue_points = Label(points_frame, text="blue", width=10)
lb_blue_points.pack(side=LEFT, pady=5, padx=10)
